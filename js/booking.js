...
class BookingSystem {
    ...
    init() {
        // Kiểm tra đăng nhập trước khi khởi tạo form
        if (!this.checkAuth()) {
            return;
        }
        ...
        this.setupTimeSlots();
        this.prefillUserInfo(); // Điền thông tin người dùng
    }
    ...
    async handleBookingSubmit(e) {
        ...
        const bookingData = {
            ...
            userId: JSON.parse(localStorage.getItem('currentUser')).id // Thêm user ID
        };
        ...
        modal.innerHTML = `
            <div class="modal-content">
                ...
                <div class="booking-details">
                    ...
                    ${booking.branch ? `<p><strong>Chi nhánh:</strong> ${this.getBranchName(booking.branch)}</p>` : ''}
                </div>
