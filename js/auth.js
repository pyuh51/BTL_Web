...
class AuthSystem {
    ...
    addPasswordToggle(passwordField) {
        ...
        const formGroup = passwordField.closest('.form-group') || passwordField.parentNode;
        if (!formGroup) return;
    ...
    async handleRegister(e) {
        ...
        try {
            ...
            if (registerResult.success) {
                ...
                this.showNotification(registerResult.message || 'Email đã được sử dụng!', 'error');
            }
        } catch (error) {
            this.showNotification('Có lỗi xảy ra, vui lòng thử lại!', 'error');
            console.error(error);
    ...
    this.showNotification('Đăng nhập thành công! Chào mừng bạn trở lại.', 'success');
    ...
    handleRegisterSuccess(userData) {
        ...
        if (loginResult.success) {
            this.showNotification('Đăng ký thành công! Tự động đăng nhập...', 'success');
    ...
    showNotification(message, type = 'success') {
        ...
        const icon = type === 'success' ? 'check' : (type === 'info' ? 'info-circle' : 'exclamation-circle');
    ...
    setupSocialLogin() {
        ...
        if (facebookBtn) {
            facebookBtn.addEventListener('click', () => {
                this.showNotification('Tính năng đăng nhập Facebook đang được phát triển', 'info');
            });
        }
    }
}
